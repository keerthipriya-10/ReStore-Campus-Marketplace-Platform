...
ReStore is a general marketplace where users can list items for sale, negotiate prices through bids, and enjoy a seamless selling experience.

## Features

- **Secure Authentication**: Implemented JWT for safe user login and registration.
- **Product Showcase**: Users can showcase their products with detailed descriptions and images.
